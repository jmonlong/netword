...
emb = read.table('frWac_no_postag_no_phrase_500_cbow_cut100.filtered.tsv.gz',
                 sep=' ', row.names=1, as.is=TRUE, comment.char='', quote='')
...
## open database
con <- dbConnect(SQLite(), dbname = "frWac_no_postag_no_phrase_500_cbow_cut100.filtered.opt.db")
